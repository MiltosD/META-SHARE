...
from metashare.repository import views as repository_views
...
urlpatterns = [
    url(r'^browse/(?P<resource_name>[\w\-]*)/(?P<object_id>\w+)/$',
        repository_views.view, name='browse'),
    url(r'^browse/(?P<object_id>\w+)/$',
        repository_views.view, name='browse'),
    url(r'^download/(?P<object_id>\w+)/$',
        repository_views.download, name='download'),
    url(r'^download_contact/(?P<object_id>\w+)/$',
        repository_views.download_contact, name='download_contact'),
    url(r'^search/$',
        search_view_factory(view_class=repository_views.MetashareFacetedSearchView,
