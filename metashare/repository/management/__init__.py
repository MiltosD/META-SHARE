...
def setup_group_global_editors(**kwargs):
    '''
...
signals.post_migrate.connect(setup_group_global_editors,
                             sender=repository_models,
                             dispatch_uid="metashare.repository.management.setup_group_global_editors")

signals.post_migrate.connect(set_site_from_django_url,
                             sender=repository_models,
                             dispatch_uid="metashare.repository.management.set_site_from_django_url")
