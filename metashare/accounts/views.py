...
def contact(request):
    ...
    return render(request, 'accounts/contact_maintainers.html', dictionary)
...
def create(request):
    ...
    return render(request, 'accounts/create_account.html', dictionary)
...
def edit_profile(request):
    ...
    return render(request, 'accounts/edit_profile.html', dictionary)
...
def editor_group_application(request):
    ...
    return render(request, 'accounts/editor_group_application.html',
                  dictionary)
...
def update_default_editor_groups(request):
    ...
    return render(request, 'accounts/update_default_editor_group.html',
                  dictionary)
...
def organization_application(request):
    ...
    return render(request, 'accounts/organization_application.html',
                  dictionary)
...
def reset(request, uuid=None):
    ...
    if not uuid:
        ...
        return render(request, 'accounts/reset_account.html', dictionary)
